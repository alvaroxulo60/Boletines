...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(laLiga.mostrarJugadoresEnComunDeDosEquipos(e1, e3));
            ...
            laLiga.jugadoresOrdenadosPorFechaNacimiento().forEach(System.out::println);

            System.out.println();
            System.out.println("############");
            //Mostramos los jugadores ordenados por edad
            System.out.println("Jugadores ordenados por nombre");
            laLiga.jugadoresOrdenadosPorNombre().forEach(System.out::println);
