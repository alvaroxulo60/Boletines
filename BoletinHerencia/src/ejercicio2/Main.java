...
public class Main {
    public static void main(String[] args) {
        ...
        while (usando) {
            ...
            try {
                int opcion = MiEntradaSalida.leerEnteroRango("¿Qué deseas hacer?",1,3);
                switch (opcion){
                    case 1:
                    ...
                    case 2:
                        ...
                        int numDias = MiEntradaSalida.leerEnteroPositivo("¿Cuántos dias vas a alquilar el vehículo?",false);
                        MiEntradaSalida.mostrarOpcionesSinNulos("Vehículos dados de alta: \n",e1.vehiculos);
                        int eleccion = MiEntradaSalida.leerEntero("Introduce la posición del vehículo que quieras calcular el alquiler: \n")-1;
            ...
            } catch (MiEntradaSalidaException | VehiculoException e) {
    ...
    public static Microbus crearMicrobus() throws VehiculoException {
        ...
        String matricula = MiEntradaSalida.leerLinea("Introduce la matricula del vehiculo: \n");
        String combustible = MiEntradaSalida.leerLinea("Introduce el combustible (Diesel o Gasolina): \n");
        int plazas = MiEntradaSalida.leerEntero("Introduce el numero de plazas");
    ...
    public static FurgonetaDeCarga crearFurgoneta() throws VehiculoException {
        ...
        String matricula = MiEntradaSalida.leerLinea("Introduce la matricula del vehiculo: \n");
        String combustible = MiEntradaSalida.leerLinea("Introduce el combustible (Diesel o Gasolina): \n");
        int pma = MiEntradaSalida.leerEntero("Introduce el peso máximo autorizado");
